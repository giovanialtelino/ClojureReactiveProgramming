...
return (new CustomEvent(event_name,(function (){var obj35630 = {"detail":data};
return obj35630;
})()));
} else {
...
var f = (function (){var pred__35637 = cljs.core._EQ_;
var expr__35638 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__35637.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__35638))){
return ((function (pred__35637,expr__35638){
return (function (p1__35631_SHARP_){
return console.warn(p1__35631_SHARP_);
});
;})(pred__35637,expr__35638))
} else {
if(cljs.core.truth_(pred__35637.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__35638))){
return ((function (pred__35637,expr__35638){
return (function (p1__35632_SHARP_){
return console.debug(p1__35632_SHARP_);
});
;})(pred__35637,expr__35638))
} else {
if(cljs.core.truth_(pred__35637.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__35638))){
return ((function (pred__35637,expr__35638){
return (function (p1__35633_SHARP_){
return console.error(p1__35633_SHARP_);
});
;})(pred__35637,expr__35638))
} else {
return ((function (pred__35637,expr__35638){
return (function (p1__35634_SHARP_){
return console.log(p1__35634_SHARP_);
});
;})(pred__35637,expr__35638))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__35641){
...
var eval_fn = cljs.core.get.call(null,map__35642__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__35644_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__35646,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1568136992707
