...
(def actor-movies
  [{:name "Cate Blanchett"
   ...
   {:name "Orlando Bloom"
    :movies ["Lord of The Rings: The Fellowship of The Ring"
             "Lord of The Rings: The Return of The King""Pirates of the Caribbean: The Curse of the Black Pearl"]}])
(def actor-spouse
  [{:name "Cate Blanchett"
    :spouse "Andrew Upton"}
   {:name "Elijah Wood"
...
(defn -main [& args]
  (time (let [cast (cast-by-movie "Lord of the Rings: The Fellowship of The Ring")
          ...
          (prn "Fetching data...")
          (pprint (apply aggregate-actor-data  (i/dderef (i/await result)))))))
